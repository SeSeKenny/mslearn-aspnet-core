...
# please open an issue on https:/github.com/SeSeKenny/mslearn-aspnet-core.
#
...
declare initScript=https://raw.githubusercontent.com/SeSeKenny/mslearn-aspnet-core/$gitBranch/infrastructure/scripts/initenvironment.sh
